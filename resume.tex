...
\section{Образование}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Институт Вычислительной Математики и Информационных Технологий, Прикладная информатика}{2027}
...
\section{Опыт работы}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {SafeBoard от Касперского}{Москва}
      {SDET Python-разработчик}{Март 2025 -- Август 2025}
      \resumeItemListStart
        \resumeItem{Разрабатывал и внедрял автоматизированные тесты на Python для проверки сетевых протоколов в системах промышленной кибербезопасности (Industrial CyberSecurity for Networks)}
        \resumeItem{Создавал тестовые скрипты для интеграционного и функционального тестирования, используя библиотеки типа pytest}
        \resumeItem{Анализировал результаты тестов, выявлял дефекты и сотрудничал с разработчиками для их устранения, способствуя повышению надежности продукта}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
